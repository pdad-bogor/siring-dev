            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form class="form-label-left input_mask">
                        <!-- Jika Sebagai Eksportir form di-hide dan value = nama eksportir-->
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 ">PPJK</label>
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" name="ppjk" class="form-control" disabled="disabled" placeholder="PPJK">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <!-- Jika sebagai PPJK form enable combobox -->
                        <div class="form-group row">
                        ...
                        <!-- Jika sebagai PPJK fome di-hide  -->
                        <div class="form-group row">
                        ...
                        <div class="form-group mb-0 row">
                            ...
                            <label class="col-form-label col-md-2 col-sm-2">Tgl. Surat <span class="required">*</span>
                            </label>
                        ...
                        <div class="form-group mb-1 row">
                            ...
                            <label class="col-form-label col-md-2 col-sm-2 ">Tgl. L/C<span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-4 ">
                        ...
                        <div class="form-group mb-0 row">
                            ...
                            <label class="col-form-label col-md-2 col-sm-2 ">Rencana Muat<span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-4 ">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-form-label col-md-2 col-sm-2 ">Perkiraan Ekspor<span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-4 ">
                        ...
                        <div class="form-group row">
                            <div class="col-md-9 col-sm-9  offset-md-12">
                                ...
                                <a href="<?= base_url('portal/im'); ?>" type="button" class="btn btn-primary">Simpan Draft</a>
                            </div>
                        </div>
                </div>
            </div>
